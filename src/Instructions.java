public class Instructions {
    public static void instructions()
    {
        ...
        System.out.println("Both Players will be given an Attack of 5, and Defence of 7.");
        ...
        System.out.println("        To capture a Grid Spot, the player will roll 3 \n"+
                            "        dice providing you with a number between 1 and 6, the \n"+
                            "        computer will roll 2 dice. If your total Attack is higher than their defence, grid is captured.");
        ...
        System.out.println("          To direct strike a heart, you must capture enough \n"+
                           "          grid spaces to complete a stright path to the end of the field");
        System.out.println("-------------------------------------------------------");
        System.out.println("-------------------------------------------------------");
    }
}
